...
<div id="content">
    	...
    	<div id="magic"><img src='<%=Url.Content("~/images/a_b_02.jpg") %>' alt="幻灯图片" width="480" height="200"></div>
        <div id="a_b_02">
        	<a href="#">电子词典专柜上线</a>
        ...
        <div id="comment_book">
        	<ul>
            	<li><a href="#"><img src='<%=Url.Content("~/images//book_01.gif") %>' alt=""></a><a href="#">中级口译试题解析</a></li>
                <li><a href="#"><img src='<%=Url.Content("~/images//book_01.gif") %>' alt=""></a><a href="#">中级口译试题解析</a></li>
                <li><a href="#"><img src='<%=Url.Content("~/images//book_01.gif") %>' alt=""></a><a href="#">中级口译试题解析</a></li>
                <li><a href="#"><img src='<%=Url.Content("~/images//book_01.gif") %>' alt=""></a><a href="#">中级口译试题解析</a></li>
                <li><a href="#"><img src='<%=Url.Content("~/images//book_01.gif") %>' alt=""></a><a href="#">中级口译试题解析</a></li>
